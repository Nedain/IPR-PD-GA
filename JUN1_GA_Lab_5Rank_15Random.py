...
while robot.step(timestep) != -1:
    ...
    #Fungsi Rank Selection
    toolbox.register("select_offspring", tools.selBest, k=5)
    ...
    with open(new_filename, "w", newline="") as csvfile:
        ...
        for gen in range(NGEN):
            ...
            #Membuat 5 keturunan individu dari Rank Selection
            selected_offspring = toolbox.select_offspring(offspring, k=5)
            
            #Membuat 15 keturunan individu baru secara acak
            random_individuals = toolbox.population(n=15)
            
            #Membuat populasi keturunan untuk generasi selanjutnya dengan ukuran 5+15 = 20
            new_pop = selected_offspring + random_individuals
            pop = new_pop
